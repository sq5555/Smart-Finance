...
class IncomePage extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> incomeItems = [
    {'icon': Icons.attach_money, 'label': 'Salary Income'},
    {'icon': Icons.show_chart, 'label': 'Investment Income'},
    {'icon': Icons.handshake, 'label': 'Business Income'},
    {'icon': Icons.home_work, 'label': 'Rental Income'},
    {'icon': Icons.account_balance, 'label': 'Governance Benefits'},
    {'icon': Icons.timelapse, 'label': 'Part-time Income'},
    {'icon': Icons.favorite, 'label': 'Donation Income'},
    {'icon': Icons.monetization_on, 'label': 'Other Income'},
  ];
                        ...
                        onPressed: () async {
                          ...
                          if (value != null && value > 0) {
                            try {
                              ...
                              await _updateTotalIncome(value);

                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                      'Successfully saved $label: RM ${value
                                          .toStringAsFixed(2)}'),
